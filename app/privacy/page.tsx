...
export default function PrivacyPolicyPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-4 lg:px-8 py-10">
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">1. Thông tin được thu thập</h2>
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">2. Mục đích sử dụng thông tin</h2>
      <ul className="list-disc list-inside text-indigo-950 space-y-1">
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">3. Chia sẻ thông tin với bên thứ ba</h2>
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">4. Lưu trữ và bảo mật</h2>
      <ul className="list-disc list-inside text-indigo-950 space-y-1">
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">5. Quyền của khách hàng</h2>
      <ul className="list-disc list-inside text-indigo-950 space-y-1">
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">6. Cookie và công cụ theo dõi</h2>
      <p className="text-indigo-950">
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">7. Liên hệ</h2>
      <p className="text-indigo-950">
