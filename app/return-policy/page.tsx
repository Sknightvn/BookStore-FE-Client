...
export default function ReturnPolicyPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-4 lg:px-8 py-10">
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">1. Thời hạn đổi trả</h2>
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">2. Trường hợp được đổi/trả</h2>
      <ul className="list-disc list-inside text-indigo-950 space-y-1">
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">3. Điều kiện sản phẩm khi đổi/trả</h2>
      <ul className="list-disc list-inside text-indigo-950 space-y-1">
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">4. Trường hợp không hỗ trợ đổi/trả</h2>
      <ul className="list-disc list-inside text-indigo-950 space-y-1">
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">5. Quy trình đổi/trả</h2>
      <ol className="list-decimal list-inside text-indigo-950 space-y-1">
