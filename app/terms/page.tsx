...
export default function TermsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-4 lg:px-8 py-10">
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">1. Chấp nhận điều khoản</h2>
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">2. Tài khoản và bảo mật</h2>
      <ul className="list-disc list-inside text-indigo-950 space-y-1">
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">3. Đặt hàng và thanh toán</h2>
      <ul className="list-disc list-inside text-indigo-950 space-y-1">
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">4. Giá bán và khuyến mãi</h2>
      <p className="text-indigo-950">
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">5. Quyền sở hữu trí tuệ</h2>
      <p className="text-indigo-950">
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">6. Giới hạn trách nhiệm</h2>
      <p className="text-indigo-950">
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">7. Thay đổi điều khoản</h2>
      <p className="text-indigo-950">
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">8. Luật áp dụng</h2>
      <p className="text-indigo-950">
      ...
      <p className="text-indigo-950 text-sm mt-4">
