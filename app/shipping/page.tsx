...
export default function ShippingPolicyPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-4 lg:px-8 py-10">
      <h1 className="text-3xl font-bold mb-4">Chính sách vận chuyển</h1>
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">1. Phạm vi giao hàng</h2>
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">2. Thời gian giao hàng dự kiến</h2>
      ...
      <p className="text-indigo-950 mt-2 text-sm">
        Thời gian trên không bao gồm ngày lễ, Tết, thiên tai, hoặc các tình huống bất khả kháng khác.
      </p>

      <h2 className="text-xl font-semibold mt-4 mb-2">3. Phí vận chuyển</h2>
      <ul className="list-disc list-inside text-indigo-950 space-y-1">
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">4. Giao hàng và kiểm tra</h2>
      <ul className="list-disc list-inside text-indigo-950 space-y-1">
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">5. Giao hàng lại</h2>
      <p className="text-indigo-950">
